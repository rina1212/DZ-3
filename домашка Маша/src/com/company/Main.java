...
// посмотри на примере 1 машины- то, что я заметила я тебе отметила коментариями или //
        ...
        while (input== 2) {
           ...
           // if (input == 2) {
                ...
                //  }
                if (input2 == 8) {// данная вставка выходит из цикла- ее необходимо добавить после каждого цикла
                    System.out.println("Кофемашина выключена");//
                    break;//
              //  }
            }
            ...
            while (input == 3) {
               //if (input == 3) {
                  ...
                  //  if (input == 3) {
                    ...
                    //  }
                    if (input3 == 8) {// данная вставка выходит из цикла- ее необходимо добавить после каждого цикла
                        System.out.println("Кофемашина выключена");//
                        break;
